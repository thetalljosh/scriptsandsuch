...
#CheckFirefox 
$FirefoxVersion = ( Invoke-WebRequest  "https://product-details.mozilla.org/1.0/firefox_versions.json" -UseBasicParsing | ConvertFrom-Json ).LATEST_FIREFOX_VERSION
Write-Host "The Latest Release of Firefox is version $FirefoxVersion."
...
Invoke-WebRequest -URI "https://download.mozilla.org/?product=firefox-latest-ssl&os=win64&lang=en-US" -OutFile $source 
